#!/usr/bin/env python3
"""
v73: Per-sample normalization — normalize each RTM independently instead of global z-score.
Removes signer-specific amplitude variation, forces model to learn relative patterns.
Born-again from v66 with extended warmup to adapt to new normalization.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v73")
...
def main():
    ...
    log.info("PER-SAMPLE NORM | Born-again v66 ext warmup | Fold %d", TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — PER-SAMPLE NORM, born-again v66",TARGET_FOLD); log.info("="*64)
