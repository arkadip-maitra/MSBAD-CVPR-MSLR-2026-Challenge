#!/usr/bin/env python3
"""
v97: Stronger augmentation + lower label smoothing (0.05).
More time masking, noise, and random erasing. Born-again from v67.
Hypothesis: v66/v67 are under-regularized, stronger aug could help.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v97")
...
CFG = {
    ...
    "label_smoothing": 0.05, "early_stopping_patience": 40,
    "grad_clip_norm": 1.0, "llrd_decay": 0.75,
    "mixup_alpha": 0.5, "cutmix_alpha": 1.0, "cutmix_prob": 0.5,
    "time_mask_max": 12, "range_mask_max": 40, "noise_std": 0.15,
    "time_warp_lo": 0.75, "time_warp_hi": 1.25,
    "time_reverse_prob": 0.5, "channel_shuffle_prob": 0.2, "channel_drop_prob": 0.1,
    "random_erase_prob": 0.30, "circ_shift_prob": 0.4, "circ_shift_max": 10,
    "amp_scale_prob": 0.5, "amp_scale_lo": 0.75, "amp_scale_hi": 1.25,
