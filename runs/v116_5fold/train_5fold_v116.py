#!/usr/bin/env python3
"""
v116: 5-fold CV — ConvNeXtV2-Tiny born-again from v113, WEAK augmentation,
FOCAL LOSS (gamma=2). 288x288 resolution. Extended 600 epochs from v113 checkpoint.
Usage: python train_5fold_v116.py --fold 0 --gpu 0
"""
...
CFG = {
    ...
    "stage2_epochs": 600, "stage2_lr": 5e-5,
