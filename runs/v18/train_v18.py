#!/usr/bin/env python3
"""
v18: ConvNeXtV2-Tiny @ HIGH-RES 384×384 + SWA
Higher resolution captures finer spatial details. Born-again from v11 + SWA.
Different view of data from v17 (native) → excellent for multi-resolution ensemble.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v18")
