#!/usr/bin/env python3
"""
v85: ConvNeXtV2-Tiny with range cropping to bins 0-128 — removes the noise-dominated
far-range bins and focuses model capacity on the body (0-10) and gesture motion (80-128)
regions. Born-again from v66, extended training.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v85")
...
class RadarDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x=(x-_MEANS)/_STDS
        # Range crop: keep bins 0-128 (body + gesture motion region, discard far-range noise)
        x = x[:, :, :128]
...
def main():
    ...
    log.info("Range crop 0-128 | born-again v66 | Fold %d", TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — Range crop bins 0-128",TARGET_FOLD); log.info("="*64)
