#!/usr/bin/env python3
"""
v45: CAFormer-S18 @ 384×384 + SWA
Push attention model to highest resolution yet.
Born-again from vit_v9 (224×224) + KD from v11 (cross-arch teacher).
Resolution ladder: vit_v9@224 → v43@320 → v45@384
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v45")
...
CFG = {
    ...
    "n_folds": 5, "batch_size": 18, "num_workers": 4,
...
def main():
    ...
    log.info("★★★ CAFormer @ %d×%d — highest-res attention model ★★★", CFG["img_size"], CFG["img_size"])
    ...
    log.info("KD α=%.2f τ=%.1f | Teacher: v11 (cross-arch) | Born-again: vit_v9@224",alpha,tau)
