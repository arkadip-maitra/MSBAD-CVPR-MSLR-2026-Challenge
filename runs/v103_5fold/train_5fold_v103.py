#!/usr/bin/env python3
"""
v103: 5-fold CV — Born-again from v101 with cosine warm restarts + higher LR.
Breaking through the 85% plateau with aggressive LR cycling.
Usage: python train_5fold_v103.py --fold 0 --gpu 0
"""
...
VERSION = "v103"
PARENT_DIR = Path("/data/slr/checkpoints_v101")
...
def main():
    ...
    log.info("5-fold CV | %s | Fold %d | Born-again from v101 | CosineWarmRestarts LR=1e-4", VERSION, TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — CosineWarmRestarts from v101",TARGET_FOLD); log.info("="*64)
    ...
    if ba.exists():
        ...
        log.warning("  No born-again checkpoint found at %s, training from pretrained!", ba)
