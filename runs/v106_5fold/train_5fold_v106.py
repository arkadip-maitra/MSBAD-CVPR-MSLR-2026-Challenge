#!/usr/bin/env python3
"""
v106: 5-fold CV — ConvNeXtV2-Tiny born-again from v103, WEAK augmentation,
NO early stopping. Full 400 epochs. Hypothesis: strong aug is the bottleneck.
Usage: python train_5fold_v106.py --fold 0 --gpu 0
"""
...
VERSION = "v106"
PARENT_DIR = Path("/data/slr/checkpoints_v103")
...
def main():
    ...
    log.info("5-fold CV | %s | Fold %d | WEAK augmentation | NO early stopping | 400 ep", VERSION, TARGET_FOLD)
