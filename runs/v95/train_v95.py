#!/usr/bin/env python3
"""
v95: Non-square input (64, 256) — preserves RTM aspect ratio.
Instead of resizing (48,256)→(224,224) which upsamples time 4.7x,
we resize to (64,256) which only pads time 1.33x.
Born-again from v67 (head adapts, backbone handles any spatial size).
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v95")
...
CFG = {
    ...
    "max_frames": 64, "img_size": (64, 256), "n_classes": 126,
