#!/usr/bin/env python3
"""
vit_v14: CAFormer-S18 @ HIGH-RES 384×384 + SWA
Same high-res approach as v18 but for CAFormer. Born-again from vit_v9 + KD from v11.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_vit_v14")
...
def main():
    ...
    log.info("★★★ CAFormer @ HIGH RESOLUTION: %s×%s ★★★", CFG["img_size"], CFG["img_size"])
