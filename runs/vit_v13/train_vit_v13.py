#!/usr/bin/env python3
"""
vit_v13: CAFormer-S18 @ NATIVE 64×256 resolution + SWA
Same native resolution idea as v17 but for the CAFormer (ViT) architecture.
Born-again from vit_v9 + KD from v11 + SWA.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_vit_v13")
...
CFG = {
    ...
    "stage2_epochs": 80, "stage2_lr": 3e-5,
...
def main():
    ...
    log.info("★★★ CAFormer @ NATIVE RESOLUTION: %s × 256 (NO RESIZE!) ★★★", CFG["max_frames"])
