#!/usr/bin/env python3
"""
v53: EfficientNetV2-S @ 320×320 + SWA. EfficientNetV2 at intermediate resolution.
...
OUT_DIR = Path("/data/slr/checkpoints_v53")
...
CFG = {
    ...
    "max_frames": 48, "img_size": 320, "n_classes": 126,
...
def main():
    ...
    log.info("★★★ EfficientNetV2-S @ 320 + SWA ★★★")
