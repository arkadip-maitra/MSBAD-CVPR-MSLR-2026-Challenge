#!/usr/bin/env python3
"""
v58: ConvNeXtV2-Tiny @ 384 + 8-Teacher Ensemble KD + SWA. Born-again from v52. Uses ALL 8 models as teachers for ~91%+ accurate soft labels.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v58")
V52_BA_DIR = Path("/data/slr/checkpoints_v52")
...
CFG = {
    ...
    "n_folds": 5, "batch_size": 24, "num_workers": 2,
...
def main():
    ...
    for fold,(tri,vai) in enumerate(skf.split(keys,labels)):
        ...
        ba=V52_BA_DIR/f"best_fold{fold}.pt"
        if ba.exists():
