#!/usr/bin/env python3
"""
v113: 5-fold CV — ConvNeXtV2-Tiny born-again from v106, WEAK augmentation,
FOCAL LOSS (gamma=2) to focus on hard confused classes (M/N, U/V, E/F etc).
Higher resolution 288x288. 400 epochs, NO early stopping.
Usage: python train_5fold_v113.py --fold 0 --gpu 0
"""
...
CFG = {
    ...
    "max_frames": 48, "img_size": 288, "n_classes": 126,
    "focal_gamma": 2.0,
