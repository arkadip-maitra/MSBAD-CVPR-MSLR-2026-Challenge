#!/usr/bin/env python3
"""
v66: Clean baseline — born-again from v11, NO KD, NO threshold, AMP + fixed LLRD.
Purpose: establish true single-fold baseline without preprocessing changes or KD.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v66")
