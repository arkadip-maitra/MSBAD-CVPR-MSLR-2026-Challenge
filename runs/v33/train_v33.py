#!/usr/bin/env python3
"""
v33: EfficientNetV2-S @ 448×448 + SWA + KD — EfficientNetV2 ultra-high-res.
Born-again from v24 (EfficientNetV2-S @384) + KD from v11+vit_v9.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v33")
...
CFG = {
    ...
    "n_folds": 5, "batch_size": 16, "num_workers": 4,
    "stage1_epochs": 5, "stage1_lr": 2e-4,
    "stage2_epochs": 80, "stage2_lr": 4e-5,
...
def main():
    ...
    log.info("KD α=%.2f τ=%.1f | born-again from v12",alpha,tau)
