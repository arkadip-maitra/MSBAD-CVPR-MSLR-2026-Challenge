#!/usr/bin/env python3
"""
v102: 5-fold CV — Born-again from v101. Round 3.
Lower LR for refinement, longer SWA, tighter patience.
Usage: python train_5fold_v102.py --fold 0 --gpu 0
"""
...
def main():
    ...
    log.info("5-fold CV | %s | Fold %d | Born-again from v101", VERSION, TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — born-again from v101",TARGET_FOLD); log.info("="*64)
