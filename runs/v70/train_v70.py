#!/usr/bin/env python3
"""
v70: Extended training — longer schedule (200 ep, patience 50, lr 2e-5),
more SWA (30 ep), born-again from v66. Tests if we're undertrained.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v70")
...
CFG = {
    ...
    "stage1_epochs": 8, "stage1_lr": 1e-4,
    "stage2_epochs": 200, "stage2_lr": 2e-5,
    "swa_epochs": 30, "swa_lr": 2e-6,
...
def main():
    ...
    log.info("EXTENDED TRAINING | 200ep patience=50 lr=2e-5 | Born-again v66 | Fold %d", TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — EXTENDED TRAINING, born-again v66",TARGET_FOLD); log.info("="*64)
