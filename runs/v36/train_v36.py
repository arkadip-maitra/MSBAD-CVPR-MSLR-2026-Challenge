#!/usr/bin/env python3
"""
v36: ConvNeXtV2-Tiny @ 224 with MEGA-TEACHER ENSEMBLE DISTILLATION + SWA.
Instead of KD from 2 teachers (v11+vit_v9), uses 5 teachers at their native
resolutions: v11@224, vit_v9@224, v18@384, v25@448, v24@384.
The student learns from soft labels equivalent to our 89.86% LB ensemble.
Born-again from v11.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v36")
...
class EvalDataset(Dataset):
    """Minimal dataset for teacher inference at arbitrary resolution."""
...
def precompute_mega_teacher_labels(keys, cache, configs, dev):
    """Pre-compute soft labels from mega-teacher ensemble at each teacher's native resolution."""
...
def main():
    ...
    log.info("★★★ MEGA-TEACHER ENSEMBLE DISTILLATION (5 teachers) ★★★")
