#!/usr/bin/env python3
"""
v87: No channel shuffle / no channel drop — preserves inter-antenna spatial
relationships. The 3 RX antennas encode angular information about the gesture
that is destroyed by random channel permutation. Born-again from v66.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v87")
...
CFG = {
    ...
    "time_reverse_prob": 0.5, "channel_shuffle_prob": 0.0, "channel_drop_prob": 0.0,
...
def main():
    ...
    log.info("No channel shuffle/drop | born-again v66 | Fold %d", TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — No channel shuffle/drop (preserve antenna info)",TARGET_FOLD); log.info("="*64)
