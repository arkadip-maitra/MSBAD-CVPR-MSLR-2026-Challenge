#!/usr/bin/env python3
"""
v40: ConvNeXtV2-Tiny @ 384 generation 2 + HEAVIER AUGMENTATION.
Born-again chain: v11@224 → v18@384 → v40@384 (gen 2).
Stronger masking, noise, erasing, mixup. Longer training (120 ep).
Different augmentation = different errors for ensemble diversity.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v40")
