#!/usr/bin/env python3
"""
v90: Born-again chain v67 → v90. Our best model (v67=90.98%) teaches a new student.
Extended training (200 ep), slightly lower LR, more SWA epochs.
No channel shuffle/drop TTA (shown to hurt), clean augmentation.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v90")
