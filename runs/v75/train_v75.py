#!/usr/bin/env python3
"""
v75: No time reversal + stronger regularization. Born-again from v66.
Time reversal changes gesture semantics (sign language is directional!).
Also increase drop_path, label_smoothing, and noise for better generalization.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v75")
...
CFG = {
    ...
    "label_smoothing": 0.15, "early_stopping_patience": 30,
    ...
    "time_reverse_prob": 0.0, "channel_shuffle_prob": 0.2, "channel_drop_prob": 0.1,
...
def main():
    ...
    log.info("NO TIME REVERSE | stronger reg | Born-again v66 | Fold %d", TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — NO TIME REVERSE + STRONG REG, born-again v66",TARGET_FOLD); log.info("="*64)
