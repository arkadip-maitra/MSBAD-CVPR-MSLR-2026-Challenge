#!/usr/bin/env python3
"""
v101: 5-fold CV — Born-again from v100 + higher LR + longer training.
Round 2 of iterative training. Each fold distills from its v100 counterpart.
Usage: python train_5fold_v101.py --fold 0 --gpu 0
"""
...
VERSION = "v101"
PARENT_DIR = Path("/data/slr/checkpoints_v100")
...
def main():
    ...
    log.info("5-fold CV | %s | Fold %d | Born-again from v100", VERSION, TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — born-again from v100",TARGET_FOLD); log.info("="*64)
