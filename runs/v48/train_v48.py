#!/usr/bin/env python3
"""
v48: EfficientNetV2-S @ 448×448 + SWA. Push EfficientNetV2 to higher resolution.
Born-again from v24 (384×384), KD from v11+vit_v9.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v48")
...
CFG = {
    ...
    "n_folds": 5, "batch_size": 20, "num_workers": 4,
...
def main():
    ...
    log.info("★★★ EfficientNetV2-S @ 448 + SWA ★★★")
    ...
    log.info("KD α=%.2f τ=%.1f | born-again from v24",alpha,tau)
