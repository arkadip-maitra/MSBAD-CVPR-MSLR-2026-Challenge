#!/usr/bin/env python3
"""
v110: 5-fold CV — ConvNeXtV2-Tiny born-again from v106, WEAK augmentation,
larger batch size (128) with scaled LR (8e-5). Persistent workers.
600 epochs, NO early stopping. Tests if larger batch+LR scaling breaks plateau.
Usage: python train_5fold_v110.py --fold 0 --gpu 0
"""
...
CFG = {
    ...
    "n_folds": 5, "batch_size": 128, "num_workers": 4,
    "stage1_epochs": 3, "stage1_lr": 1e-4,
    "stage2_epochs": 600, "stage2_lr": 8e-5,
    "swa_epochs": 30, "swa_lr": 5e-6,
...
def main():
    ...
    log.info("5-fold CV | %s | Fold %d | WEAK aug | batch=128 | LR=8e-5 | 600 ep", VERSION, TARGET_FOLD)
