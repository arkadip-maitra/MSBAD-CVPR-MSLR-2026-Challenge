#!/usr/bin/env python3
"""
v114: 5-fold CV — ConvNeXtV2-Tiny born-again from v106, WEAK augmentation,
FOCAL LOSS (gamma=2) at standard 224x224. Clean test of focal loss effect.
400 epochs, NO early stopping.
Usage: python train_5fold_v114.py --fold 0 --gpu 0
"""
...
def main():
    ...
    log.info("5-fold CV | %s | Fold %d | WEAK aug | Focal(γ=%.1f) | 224px | 400 ep", VERSION, TARGET_FOLD, CFG["focal_gamma"])
