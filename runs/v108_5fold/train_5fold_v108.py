#!/usr/bin/env python3
"""
v108: 5-fold CV — ConvNeXtV2-BASE + WEAK augmentation + 400 epochs.
Combines Base model capacity with the proven weak-aug training strategy.
Usage: python train_5fold_v108.py --fold 0 --gpu 0
"""
...
def main():
    ...
    log.info("5-fold CV | %s | Fold %d | ConvNeXtV2-BASE | WEAK aug | 400 ep | born-again v104", VERSION, TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — BASE + WEAK aug + born-again v104",TARGET_FOLD); log.info("="*64)
