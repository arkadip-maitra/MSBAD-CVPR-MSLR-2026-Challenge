#!/usr/bin/env python3
"""
v57: ConvNeXtV2-Tiny @ 224 + 8-Teacher Ensemble KD + SWA. Born-again from v11. Uses ALL 8 models as teachers for ~91%+ accurate soft labels.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v57")
