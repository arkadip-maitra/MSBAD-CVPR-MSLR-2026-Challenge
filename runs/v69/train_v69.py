#!/usr/bin/env python3
"""
v69: Rectangular resolution (128, 256) — preserve native 256 range bins,
reduce temporal upsampling from 4.7x to 2.67x. Born-again from v66.
Hypothesis: the severe 224x224 resize distorts the natural (48, 256) aspect ratio.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v69")
...
CFG = {
    ...
    "max_frames": 48, "img_size": [128, 256], "n_classes": 126,
...
def main():
    ...
    log.info("RECTANGULAR (128,256) | Born-again v66 | Fold %d", TARGET_FOLD)
    ...
    log.info("="*64); log.info("FOLD %d — RECT (128,256), born-again v66",TARGET_FOLD); log.info("="*64)
