#!/usr/bin/env python3
"""
v43: CAFormer-S18 @ 320×320 + SWA
Push the only attention-based model to higher resolution.
Born-again from vit_v9 (224×224) + KD from v11 (cross-arch teacher).
Resolution ladder for CAFormer: vit_v9@224 → v43@320
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v43")
BA_DIR = Path("/data/slr/checkpoints_vit_v9")
...
CFG = {
    ...
    "n_folds": 5, "batch_size": 28, "num_workers": 4,
...
def main():
    ...
    log.info("★★★ CAFormer @ %d×%d — resolution ladder from vit_v9@224 ★★★", CFG["img_size"], CFG["img_size"])
    ...
    log.info("KD α=%.2f τ=%.1f | Teacher: v11 (cross-arch) | Born-again: vit_v9",alpha,tau)
