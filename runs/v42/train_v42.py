#!/usr/bin/env python3
"""
v42: CAFormer-S18 @ 224 with HEAVY AUGMENTATION + extended training.
Born-again from vit_v9. Significantly stronger augmentation than standard
(more masking, noise, erasing, mixup). 150 epochs, patience 50.
Attention-based models may be more sensitive to augmentation changes than CNNs.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v42")
...
def main():
    ...
    log.info("★★★ CAFormer + HEAVY AUGMENTATION + EXTENDED TRAINING ★★★")
