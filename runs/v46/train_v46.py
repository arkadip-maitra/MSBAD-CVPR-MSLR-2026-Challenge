#!/usr/bin/env python3
"""
v46: CAFormer-S18 @ 448×448 + SWA
Ultra-high-res attention model. Born-again from vit_v9 (224×224).
KD from v11 (cross-arch teacher).
Resolution ladder: vit_v9@224 → v43@320 → v45@384 → v46@448
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v46")
...
CFG = {
    ...
    "n_folds": 5, "batch_size": 12, "num_workers": 4,
...
def main():
    ...
    log.info("★★★ CAFormer @ %d×%d — ultra-high-res attention ★★★", CFG["img_size"], CFG["img_size"])
