#!/usr/bin/env python3
"""
v25: ConvNeXtV2-Tiny @ ULTRA-HIGH-RES 448×448 + SWA
Highest resolution yet. Born-again from v18 (384×384) + KD from v11+vit_v9.
Extends the resolution ladder to capture maximum spatial detail.
"""
import os
...
OUT_DIR = Path("/data/slr/checkpoints_v25")
